...
const Hero = () => {
    return (
        <section className="section min-h-screen bg-gradient-to-b from-white from-25% to-amber-100 to-100% container_width py-15 pt-15 lg:pt-12 flex flex-col justify-center lg:flex-row gap-25 lg:gap-25 lg:justify-start lg:items-center sm:gap-22">

    ...
    return (
        <section className="section container_width">
            <motion.div
                ...
                className="relative lg:mx-10 min-h-screen bg-gradient-to-b from-white from-25% to-amber-100 to-100% flex flex-col justify-center lg:flex-row gap-25 lg:gap-25 lg:justify-start lg:items-center sm:gap-22 py-15 pt-15 lg:pt-12"
            >
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="px-3 lg:px-10 relative z-20 flex flex-col gap-2 sm:gap-5 justify-center items-center text-center lg:text-left lg:items-start sm:!w-[470px] mx-auto lg:mx-0 lg:!w-1/2"
                >
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="flex flex-col gap-2 items-center lg:items-start w-[85%] sm:!w-[70%] lg:!w-full max-w-[430px]"
                    >
                        <Image
                            src="/camp.svg"
                            alt="camp"
                    ...
                    >
                        Discover the world’s untouched beauty with ease. From hidden gems to breathtaking landmarks, our app makes every journey simple, inspiring, and unforgettable.
                    </motion.p>
                    <motion.div
                        initial={{ y: 20, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="px-5 sm:!px-15 lg:!px-0 w-full max-w-[300px] sm:max-w-[370px] lg:max-w-[fit-content] flex flex-col lg:flex-row justify-center lg:justify-start items-center lg:items-start gap-2.5 sm:w-[370px] lg:w-[fit-content]"
                    >
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="animate-[float_3s_ease-in-out_infinite] w-[fit-content] translate-x-10 sm:translate-x-[400px] lg:translate-x-0 relative z-20 rounded-2xl flex flex-col gap-2 px-4 py-6 pt-4 bg-gray-950"
                        >

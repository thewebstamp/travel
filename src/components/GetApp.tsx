...
const GetApp = () => {
    return (
        <section id="get_app" className="relative z-20 container_width bg-[url('/pattern.png')] bg-center bg-cover pt-15 pb-11 lg:max-h-[550px] overflow-hidden lg:rounded-3xl">
            <div className="lg:mx-10 flex flex-col sm:flex-row items-center lg:justify-between gap-17">

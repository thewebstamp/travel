...
const GetApp = () => {
    return (
        <section id="get_app" className="container_width">
            <div className="lg:mx-10 relative z-20 bg-[url('/pattern.png')] bg-center bg-cover pt-15 pb-11 lg:max-h-[550px] overflow-hidden lg:rounded-3xl flex flex-col sm:flex-row items-center lg:justify-between gap-17">
                <div className="flex flex-col items-center sm:items-start gap-1 text-center sm:text-left px-2.5 lg:px-10 sm:pl-10 sm:min-w-[370px] lg:min-w-[500px]">
                    ...
                    <p className="text-[16px] text-gray-200">Available on ios and android, download now!</p>

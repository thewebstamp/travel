...
const Footer = () => {
    return (
        <footer className="container_width text-center lg:text-left bg-gradient-to-b from-white from-40% to-amber-100 pt-10 sm:pt-15 lg:pt-20">
            <div className="lg:mx-10 flex flex-col gap-14 sm:gap-18 lg:gap-13">
